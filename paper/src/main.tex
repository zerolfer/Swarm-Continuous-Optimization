...
\begin{document}
    ...
    \comment{ % por falta de espacio se omite la figura y su párrafo
    \begin{figure}[htbp]
        \includegraphics[width=0.8\textwidth]{"vectores"}
        \centering
        \caption{}
        \label{fig:1}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=0.5\textwidth]{graficas_ackley}
        \label{fig:2:a}
        }
        \subfigure[Curvas de nivel]{
        \includegraphics[width=0.4\textwidth]{graficas_ackley_contorno}
        \label{fig:2:b}
        }
